...
\subsubsection{Flow of Control}\label{sec:flowofcontrol}
...
class Parameter:
    ...
    def update(self, arg = None, widget = None, value=None):
        ...
        if value is not None:
            self.value = value
\end{lstlisting}
\caption{Class Parameter Declaration.}\label{fig:classparam}
\end{figure}
...
\end{lstlisting}
\caption{Parameter Object Instantiation.}\label{fig:paraminstantiation}
\end{figure}
...
\end{lstlisting}
\caption{Addition of Sweep Points to Method setAnalyzerValue.}\label{fig:setanalyzervalue}
\end{figure}
