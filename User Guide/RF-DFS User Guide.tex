...
\begin{enumerate}
  ...
  \item One Condor MB24-1.2-AG 24V 1.2A linear power supply
\end{enumerate}
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \matrix[wire board, wiresright] (plc) {
        ...
        \draw(v2circ2)[->] -- (v2circ2 |- plc-17-3.south west) -- (plc-17-3.south west -| 5e) coordinate(topower+) node[anchor=west]{\footnotesize To MB24-1.2-AG +24V};
        % plc ground wires
        ...
        \draw(gndnode3)[->] -- (gndnode3 -| topower+) node[anchor=west]{\footnotesize To MB24-1.2-AG GND};
        % lps cont
